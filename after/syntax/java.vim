...
call IMAP('psvm', 'public static void main(String[] args){<++>}', 'java')
call IMAP('{}', '{<++>}', 'java')
call IMAP('[]', '[<++>]<++>', 'java')
call IMAP('()', '(<++>)<++>', 'java')
call IMAP('<>', '<<++>>', 'java')
call IMAP('""', '"<++>"<++>', 'java')
call IMAP('snout', 'System.out.println(<++>);', 'java')
call IMAP('sout', 'System.out.print(<++>);', 'java')
call IMAP('serr', 'System.err.print(<++>);', 'java')
